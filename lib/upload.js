...
Slingshot.Upload = function (directive, metaData) {
  ...
  function buildFormData() {
    // If postData is not provided, we just need to PUT the contents
    if(self.instructions.postData[0].name == "ignore") return self.file
  ...
  _.extend(self, {
    ...
    */
    ...
    transfer: function (callback) {
      ...
      var method = self.instructions.method || "POST"
